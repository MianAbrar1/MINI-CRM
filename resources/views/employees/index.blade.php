    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <br>
          <div>
            <button class="btn"><a href="{{ route('employees.create') }}">Create New Employee</a></button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <tbody>
                @foreach($employees as $employee)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-block btn-outline-success btn-sm" href="{{ route('employees.edit', $employee->id) }}">Edit</a>
                            <form method="post" action="{{ route('employees.destroy', $employee->id) }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit"class="btn btn-block btn-outline-danger btn-sm"  onclick="return confirm('Are you sure you want to delete this employee?')">Delete</button>
                            </form>
                        </td>
                    </tr>
                @endforeach
